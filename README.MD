...
- Add storage for teachers.
- Add storage for rentals
- Implement persistent IDs
- Implemented Unit Testings for all classes
...
- Implement a (TDD) Test Driven Development approach.
